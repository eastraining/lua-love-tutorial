...
local begin_contact_callback = function(fixture_a, fixture_b, contact)
  ...
  print(name_a, name_b, x1, y1, x2, y2, 'beginning contact')
end
...
local end_contact_callback = function(fixture_a, fixture_b, contact)
  ...
  print(name_a, name_b, x1, y1, x2, y2, 'ending contact')
end
...
local pre_solve_callback = function(fixture_a, fixture_b, contact)
  ...
  print(name_a, name_b, x1, y1, x2, y2, 'about to resolve a contact')
end
...
local post_solve_callback = function(fixture_a, fixture_b, contact)
  ...
  print(name_a, name_b, x1, y1, x2, y2, 'just resolved a contact')
end
